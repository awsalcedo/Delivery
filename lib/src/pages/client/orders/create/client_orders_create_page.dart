...
import 'package:delivery_alex_salcedo/src/pages/client/orders/create/client_orders_create_controller.dart';
        ...
        child: Column(
          children: [
            Divider(
              ...
              endIndent: 30, // Para definir margen en la parte derecha
              indent: 30, // Para definir margen en la parte izquierda
            ),
            _textTotalPrice(),
            _buttomConfirmOrder()
          ],
