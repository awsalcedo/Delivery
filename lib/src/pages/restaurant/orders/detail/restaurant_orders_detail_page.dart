...
import 'package:delivery_alex_salcedo/src/pages/restaurant/orders/detail/restaurant_orders_detail_controller.dart';
...
class _RestaurantOrdersDetailPageState
  ...
  Widget _textDescriptionDelivery() {
    return Container(
            ...
            children: [
              Container(
                ...
                child: DropdownButton(
                  ...
                  items: _dropDownItemsDelivery(users),
                  value: _con.idDelivery,
                  onChanged: (option) {
                    setState(() {
                      print('Reparidor selecciondo $option');
                      // Asignar el repartidor seleccionado por el usuario
  ...
  List<DropdownMenuItem<String>> _dropDownItemsDelivery(List<User> users) {
