import 'package:delivery_alex_salcedo/src/models/rol.dart';
import 'package:delivery_alex_salcedo/src/pages/roles/roles_controller.dart';
          ...
          child: ListView(
              children: _con.user != null
                  ? _con.user.roles.map((Rol rol) {
                      return _cardRole(rol);
                    }).toList()
                  : []),
        ));
  }

  Widget _cardRole(Rol rol) {
