class MercadoPagoTransactionDetail {
  ...
  MercadoPagoTransactionDetail({this.externalResourceUrl});
  ...
  MercadoPagoTransactionDetail.fromJsonMap(Map<String, dynamic> json) {
    ...
    netReceivedAmount = (json['net_receivedA_amount'] != null)
        ? double.parse(json['net_receivedA_amount'].toString())
        : 0;
    totalPaidAmount = (json['total_paid_amount'] != null)
        ? double.parse(json['total_paid_amount'].toString())
        : 0;
    overpaidAmount = (json['overpaid_amount'] != null)
        ? double.parse(json['overpaid_amount'].toString())
        : 0;
    externalResourceUrl = json['external_resource_url'];
    installmentAmount = (json['installment_amount'] != null)
        ? double.parse(json['installment_amount'].toString())
        : 0;
